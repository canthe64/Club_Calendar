...
/// admin action at all - only the one-time setup (granting GroupMember.Read.All + User.Read.All,
/// creating the group)
/// does.
/// </summary>
public class StaffAccessService(IGraphGroupGateway groupGateway, FacilityConfiguration facility, AppLogService log)
{
    ...
    /// or unconsented Graph permission) is logged and treated as "not staff" for that sign-in, never as
